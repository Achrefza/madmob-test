    ...
    <section id="projects" className="relative overflow-hidden border-t border-white/10 px-6 py-20 sm:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        <div className="mb-10 sm:mb-14">
          <p className="font-madmob text-xs tracking-[0.35em] text-[var(--accent-red)] uppercase">T h e   J o u r n e y</p>
          <h2 className="font-madmob mt-3 text-3xl font-semibold tracking-tight text-white sm:text-4xl">D j i n g  and  e v e n t s </h2>
        </div>
